...
* [`checking`](https://github.com/TiarkRompf/reachability/tree/main/checking/) -- Coq mechanization of the $\lambda^\diamond_R$-calculus [5] and its type checking algorithm.
