...
Proof.
  ...
  unfold_Q. unfold_N. split.
  intros. ndestruct (bvs b); intuition. eauto 3 with arith.
  split. intros. ndestruct (bvs b); intuition. eauto 3 with arith. eapply closed_Nats_tighten; eauto.
    intros. ndestruct (bvs b); intuition.
Qed.
Lemma closed_qual_open' : forall {d b f l},
...
Proof.
  ...
  ndestruct (bvs0 k);
  ndestruct (bvs k);
  ndestruct (n_one (S g) 0); simpl;
  apply Q_lift_eq; clift; simpl.
  2: exfalso; Qcrush; eauto. 3: Qcrush; exfalso; eauto. (*slow*)
  4: exfalso; Qcrush; eauto. 
  all: Qcrush.
Qed.
...
Proof.
  ...
  ndestruct (bvs0 k);
  ndestruct (bvs k);
  ndestruct ((n_splice 0 fvs1) 0); simpl;
  apply Q_lift_eq; clift; simpl. 
  2: exfalso; Qcrush; eauto. 3: Qcrush; exfalso; eauto. (*slow*)
  4: exfalso; Qcrush; eauto. 
  all: Qcrush.
...
unfold_q.
ndestruct (bvs i); ndestruct (bvs j); ndestruct (bvs0 i); ndestruct (bvs0 j); simpl; apply Q_lift_eq; simpl.
  1-3: exfalso; Qcrush; eauto. Qcrush; exfalso; eauto.
  5-7: exfalso; Qcrush; eauto. 
  all: Qcrush. 
Qed.
...
ndestruct (bvs i); ndestruct (bvs j); simpl; apply Q_lift_eq.
4: { Qcrush; exfalso; eauto. }
1: { qual_destruct d'. qual_destruct d''. ndestruct (bvs0 i); ndestruct (bvs0 j); ndestruct (bvs1 i); ndestruct (bvs1 j); simpl.  
  1-15: exfalso; Qcrush; eauto. Qcrush; exfalso; eauto. }
1: { qual_destruct d'. qual_destruct d''. ndestruct (bvs0 i); ndestruct (bvs0 j); ndestruct (bvs1 i); ndestruct (bvs1 j); simpl. 
  1-15: exfalso; Qcrush; eauto. Qcrush; exfalso; eauto. }
1: { qual_destruct d'. qual_destruct d''. ndestruct (bvs0 i); ndestruct (bvs0 j); ndestruct (bvs1 i); ndestruct (bvs1 j); simpl. 
  1-15: exfalso; Qcrush; eauto. Qcrush; exfalso; eauto. }
...
Proof.
  ...
  apply Q_lift_eq; clift; auto.
  Qcrush. Qcrush. exfalso; Qcrush; eauto. Qcrush; exfalso; eauto. Qcrush. Qcrush. exfalso; Qcrush; eauto. exfalso; Qcrush; eauto.
Qed.