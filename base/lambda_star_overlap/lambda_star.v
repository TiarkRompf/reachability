...
Lemma substitution_gen :
  ...
  - simpl. assert (HwfG' : wf_tenv ((T1, d1) :: Γ0 ++ [(Tx, dx)]) Σ). apply wf_tenv_cons; auto.
...
Lemma substitution : forall {t df Tx dx Σ T d},
    has_type [(Tx,df ⋒ dx)] (df ⊔ (just_fv 0)) Σ t T d -> wf_tenv [(Tx,df ⋒ dx)] Σ -> closed_qual 0 0 (length Σ) df ->
    ...
    + (* beta *)
      ...
      * apply (Preserve Σ ∅); auto. rewrite qqplus_qbot_right_neutral.
        ...
        assert (HT' : has_type [(T1, df ⋒ d1)] (df ⋓ just_fv 0) Σ (open_tm' ([]:tenv) t0) (open_ty' ([]:tenv) T2) (openq' ([]:tenv) d3)). {
          eapply narrowing; eauto. eapply weaken_flt; eauto. apply subqual_qlub. inversion H32. subst. auto.
        ...
        eapply t_sub; eauto.
        inversion H25. subst. clear H43. rename H33 into Hsub.
        ...
        apply openq_subqual; auto. apply qlub_bound; auto. apply has_type_filter in H. auto.
    ...
    + (*  t t2 -> t' t2  *)
      ...
      * rewrite <- openq_u_distribute1. eapply t_sub with (T1 := T)(d1 := (openq d1 d2)).
        ...
        -- apply stp_refl. simpl. eapply closed_ty_monotone; eauto. lia.
           ...
           eapply closed_qual_open'; eauto. apply closed_qual_qqplus. inversion H12. subst.
