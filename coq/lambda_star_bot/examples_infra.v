...
Lemma unopen_subqual : forall {x q2 df l}, closed_qual 1 x l q2 -> closed_qual 0 x l df -> df <> qbot ->
  ...
  destruct (NatSet.F.mem 0 t1) eqn:Hmem; simpl in *; intuition; rewrite <- NatSetFacts.not_mem_iff in H9, H12, H13.
  clear H2. clear H5. fnsetdec. clear H3. clear H5. fnsetdec.
  clear H3. clear H2. fnsetdec. all : fnsetdec.
Qed.
...
Ltac T_VAR :=
  ...
  | [ |- has_type _ _ _ (tvar (varF ?x)) _ (⊥) ]                                      => rewrite <- (qplus_bot x); try T_VAR
