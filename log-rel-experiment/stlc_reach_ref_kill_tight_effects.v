...
| t_abs: forall env t T1 T2 p q2 qf e2 k2 (q2x e2x k2x: bool),
    ...
    psub (plift qf) (pdom env) -> (* psub (plift qf) (plift p) ->  *)
    (*  *)
...
Proof.
  ...
  *)
  ...
  unfoldq. intuition. destruct (H16 x) as [[x0 ?] [? ?]|]; eauto. 
Qed.
...
Proof.
  ...
  - (* from func *)
    ...
    destruct H8 as [? [? ?]]. rewrite indexr_skip in H8; eauto.
  ...
  - destruct H8.
    ...
    rewrite indexr_skip in H8; eauto. lia.
...
Lemma empty_filter: forall G t T p q e k,
    has_type G t T p q e k ->
