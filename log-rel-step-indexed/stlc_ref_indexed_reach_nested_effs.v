...
Proof.
  ...
  edestruct (HX (1+n) S M E V u) as (M' & vx & ls' & SC' & ST' & SEX & RX & VX & VQ & Ht). eauto. 
  {
...
Proof.
  ...
  - intros ? ? ? ?. 
    bdestruct (l =? i). {
      subst l. destruct (VQX i). auto.  
      assert False. eapply H2. eapply vars_locs_monotonic. 2: eapply H4. auto. contradiction.
      destruct fr1; try contradiction. destruct H4. eapply indexr_var_some' in H3. 
      unfold st_locs, pnat in H5. destruct ST. lia.
    } {
...
Proof.
  ...
  intros n1 S1 r1 EV.  
  edestruct (H n S M H2) as [M2 [vx [lvx [SC1 [ST1 [SE1 [HR [HVX [HQX HPX]]]]]]]]].
  eauto. eauto. eauto. eauto. eauto. 
